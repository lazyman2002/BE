...
public final class GroupServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<proto.ServerChat.GroupMember,
      com.google.protobuf.BoolValue> getGroupDeleteMemberMethod() {
    io.grpc.MethodDescriptor<proto.ServerChat.GroupMember, com.google.protobuf.BoolValue> getGroupDeleteMemberMethod;
      ...
      synchronized (GroupServiceGrpc.class) {
        if ((getGroupDeleteMemberMethod = GroupServiceGrpc.getGroupDeleteMemberMethod) == null) {
          GroupServiceGrpc.getGroupDeleteMemberMethod = getGroupDeleteMemberMethod =
              io.grpc.MethodDescriptor.<proto.ServerChat.GroupMember, com.google.protobuf.BoolValue>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class GroupServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void groupDeleteMember(proto.ServerChat.GroupMember request,
        io.grpc.stub.StreamObserver<com.google.protobuf.BoolValue> responseObserver) {
  ...
  public static final class GroupServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<GroupServiceBlockingStub> {
    ...
    /**
     */
    public com.google.protobuf.BoolValue groupDeleteMember(proto.ServerChat.GroupMember request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  private static final int METHODID_GROUP_LIST_READ = 4;
  private static final int METHODID_GROUP_APPEND_MEMBER = 5;
  private static final int METHODID_GROUP_DELETE_MEMBER = 6;
